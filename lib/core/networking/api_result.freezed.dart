...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( Failure<T> value)?  failure,TResult Function( Success<T> value)?  success,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( Failure<T> value)  failure,required TResult Function( Success<T> value)  success,}){
final _that = this;
switch (_that) {
case Failure():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( Failure<T> value)?  failure,TResult? Function( Success<T> value)?  success,}){
final _that = this;
switch (_that) {
case Failure() when failure != null:
return failure(_that);case Success() when success != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( ApiErrorModel error)?  failure,TResult Function( T data)?  success,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Failure() when failure != null:
return failure(_that.error);case Success() when success != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( ApiErrorModel error)  failure,required TResult Function( T data)  success,}) {final _that = this;
switch (_that) {
case Failure():
return failure(_that.error);case Success():
return success(_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( ApiErrorModel error)?  failure,TResult? Function( T data)?  success,}) {final _that = this;
switch (_that) {
case Failure() when failure != null:
return failure(_that.error);case Success() when success != null:
return success(_that.data);case _:
